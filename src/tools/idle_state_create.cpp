// idle_state_create.cpp
// idle state for handling mouse press to start creating a new shape
...
// on mouse press, if in a shape mode, create a new shape instance with default
// style and switch to creating state to handle the drag for geometry updates
